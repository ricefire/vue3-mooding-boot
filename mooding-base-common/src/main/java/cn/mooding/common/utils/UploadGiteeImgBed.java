...
public class UploadGiteeImgBed {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "0e2f681d18b2e884019903eabbef860e";  //这里不展示我自己的了，需要你自己补充

    /**
     * 码云个人空间名
     */
    public static final String OWNER = "dlisnow";

    /**
     * 上传指定仓库
     */
    public static final String REPO = "personal-repo";


    /**
     * 上传时指定存放图片路径
     */
    public static final String PATH = "/upload/mooding/%s/" + DateUtils.getYearMonth() + "/"; //使用到了日期工具类
    ...
    public static String uploadFileToGitee(MultipartFile multipartFile) throws Exception {
        ...
        log.info("响应data为：" + content.toString());
        giteeUrl = (String) content.getObj("download_url");
        return giteeUrl;
    }
